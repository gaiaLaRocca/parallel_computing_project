...
una frangia larga circa un pixel lungo il contorno, e che lo sbilanciamento del
carico dipende dalla geometria dell'insieme molto più che dalla soglia.
...
strutture: corregge una frangia larga circa un pixel lungo il contorno.
...
tendenza monotona. Il dato è coerente con un risultato teorico noto: il bordo
dell'insieme di Mandelbrot ha dimensione di Hausdorff, e dunque di box, pari a
$2$~\cite{shishikura1998}, la stessa dimensione del piano che lo contiene, per
cui i pixel di bordo scalano come i pixel totali. Ne discendono due conseguenze.
La prima è che raffinare la griglia non migliora la qualità \emph{relativa}
della classificazione: aumenta nella stessa proporzione il numero di pixel
risolti e quello dei pixel incerti. La seconda offre una lettura geometrica
dell'invarianza di $\lambda$ e $\mathrm{CoV}$ osservata al variare della
risoluzione: se ogni popolazione definita sul bordo mantiene frazione costante,
anche il profilo di carico per riga, che dal bordo dipende, conserva la propria
forma relativa.
