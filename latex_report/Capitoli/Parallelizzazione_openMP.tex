...
esplicito: leggono e scrivono la stessa matrice degli escape time $n(r,c)$,
...
\begin{table}[htbp]
    ...
    \begin{tabular}{llll}
        ...
        \texttt{dynamic,16} & $1{,}006 \to 0{,}725$      & cresce, $-0{,}0018 \to 0{,}0122$   & contesa sulla coda \\
...
$p = H$. Che $e(32) = 0{,}0538$ sia già sceso \emph{sotto}
$1/12{,}02 \approx 0{,}083$ è la verifica diretta di questo punto, e sarebbe
impossibile per una metrica che vi convergesse dall'alto.

\medskip
\noindent\emph{Le politiche a $e(p)$ crescente.}
Per \texttt{dynamic,1} e \texttt{dynamic,16} la metrica parte da zero e cresce
di poco ($0{,}0011$ e $0{,}0122$ a $p = 32$): è il costo di coordinamento della
coda condivisa, che aumenta con il numero di thread che vi accedono. Non c'è
qui alcun tetto --- l'efficienza resta alta --- e infatti i valori restano di
uno o due ordini di grandezza sotto quelli delle politiche sbilanciate.

\texttt{dynamic,64} appartiene alla stessa direzione ma per una ragione diversa,
ed è il solo caso dello sweep in cui il tetto è genuinamente fisso. I $16$ chunk
