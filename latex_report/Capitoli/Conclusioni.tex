...
$8$ processi; a $16$ e $32$ se ne allontana, per una causa ancora da verificare.
...
quasi ideale e da sola non spiega le perdite osservate. La metrica di
Karp--Flatt le segnala correttamente, ma non misura una frazione seriale: per la
regola a blocchi $e(p)$ decresce con $p$ e segue la forma
...
indica uno sbilanciamento il cui limite cresce con $p$, una crescente un limite
fisso, come la granularità o la contesa sulla coda.
...
precisione e throughput; la misura diretta del costo di riordino nella
